import 'dart:async';
import 'package:maseeha_update/Patient/TeleMedicine/Controllers/agora_controller.dart';
    ...
    if (isSomeOneJoinedCall) {
      Future.delayed(Duration(milliseconds: 300), () {
        Navigator.pushReplacement(
            context, MaterialPageRoute(builder: (context) => TeleMedicineHomePage()));
      });
    } else {
      showDialog(
        context: context,
        ...
        builder: (context) => AlertDialog(
          ...
          actions: <Widget>[
            ...
            FlatButton(
              child: Text(DemoLocalization.of(context).getTranslatedValue(
                        'yes',
                      )),
              onPressed: () {
                Navigator.pop(context); // Close dialog
                Navigator.pushReplacement(context,
                    MaterialPageRoute(builder: (context) => TeleMedicineHomePage()));
              },
            ),
            // ignore: deprecated_member_use
            FlatButton(
