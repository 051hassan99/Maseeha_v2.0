...
class AddMedicine extends StatelessWidget {
  ...
  final TextEditingController doseDateController =
      new TextEditingController();
  final TextEditingController medMsgController =
      new TextEditingController();
                              ...
                              children: <Widget>[
                                new Padding(
                                  ...
                                  child: new TextFormField(
                                    ...
                                    onChanged: (String value) {
                                      ...
                                      localNotificationImplement.title = value;
                                ...
                                Padding(
                                    ...
                                    child: new TextFormField(
                                      ...
                                      onChanged: (String value) {
                                        localNotificationImplement.body = value;
                                          addMedicineData.medDescription = value;
                                 ...
                                 Padding(
                                    ...
                                    child: new TextFormField(
                                      ...
                                      decoration: new InputDecoration(
                                          hintText: "Date in the format (YYYY-MM-DD)",
                                          hintStyle: TextStyle(
                                              fontFamily:
                                                  'Jameel Noori Nastaleeq Kasheeda'),
                                          enabled: true,
                                      ...
                                      onChanged: (String value) {
                                        localNotificationImplement.date = value;
                                ...
                                new Padding(
                                  ...
                                  child: new TextFormField(
                                    ...
                                    decoration: new InputDecoration(
                                        hintText: "Time Format(HH:MM (PM/AM))",
                                        hintStyle: TextStyle(
                                            fontFamily:
                                                'Jameel Noori Nastaleeq Kasheeda'),
                                        enabled: true,
                                              ...
                                              onPressed: () async {
                                                ...
                                                //   final progress = ProgressHUD.of(context);
                                                 //   progress?.show();
                                                  ...
                                                  addMedicineData.toggleLoading();
                                                  localNotificationImplement.timeConvert();

                                                  localNotificationImplement.mergeTimeAndDate();

                                                  medNameController.clear();
                                                  medMsgController.clear();
                                                  doseTimeController.clear();
                                                  doseDateController.clear();
                                               localNotificationImplement.intializeSetting();

                                               localNotificationImplement.showNotification();
